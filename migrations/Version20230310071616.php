 ...
 */
final class Version20230310071616 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE product (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, author_id INT NOT NULL, product_name VARCHAR(255) NOT NULL, images_product VARCHAR(255) NOT NULL, number_chapter VARCHAR(255) NOT NULL, product_link VARCHAR(255) NOT NULL, product_date DATE NOT NULL, INDEX IDX_D34A04AD12469DE2 (category_id), INDEX IDX_D34A04ADF675F31B (author_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
